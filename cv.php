...
try {
    ...
    $sth=$dbco->prepare("
        INSERT INTO CV(nom,tel,email,nationality,prof,competences,experience,experiences
        lan,dip,insert)
        VALUES(:nom,:tel,:email,:nationality,:prof,:competences,
        experience,:experiences,:lan,:dip,:insert,)");
